...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
      <div class="logo"><a href="#">OLOC</a></div>
      ...
      <nav class="main_nav">
        <ul class="d-flex flex-row align-items-center justify-content-start">
          ...
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=rooms">Packages and Tours</a></li> 
...
<!--         <div class="search_button">
        ...
        <!-- Header Link -->
        <div class="header_link"><a href="#">Book Your packages Now</a></div>
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <div class="logo_hr"><a href="#">OLOC</a></div>
    </div>
  </div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_text text-center"> One Life One Choice </div>
      <div class="home_title"><h1>The Diaries of memories</h1></div>
      <div class="home_text text-center">We think travel in itself is a success. It’s an explosive expression of humanity. It’s something we are all touched by. No matter where are we from, everyone loves to travel.</div>
...
<div class="rooms">
  ...
  <footer class="footer">
    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo WEB_ROOT;?>images/foot.jpg" data-speed="0.8"></div>
    <div class="container">
      <div class="row">
        <div class="col">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://facebook.com" target="_blank">Sujan D</a>
